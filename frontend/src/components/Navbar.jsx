    ...
    return (
        <>
            <nav className="navbar">
                <Link>
                    <img src={logo} alt="" className="flex-none w-14 h-12" />
                </Link>

                <div className={`absolute bg-white w-full left-0 top-full ml-[4vw] mt-0.5 border-b border-gray py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show ${searchBoxVisibility ? 'show' : 'hide'}`}>
                    ...
                    {access_token ? (
                        <>
                            <Link to="/dashboard/notification">
                                <button className="w-12 h-12 rounded-full bg-gray  hover:bg-black/10">
